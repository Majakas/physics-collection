...
#for prob in manager.collection_two.problems[194:195]:
#    print(prob.name, prob.year, prob.round, prob.number)
#exit(0)
#manager.collection_two.problems = manager.collection_two.problems
#manager.collection_two.problem_sort_by_year()
